...
def getFarmers(request):
        ...
        if response is not None:
            try:
                ...
                kebele_name=request_user.kebelebusiness.created_by.kebele_name
                farmers = Farmer.objects.filter(created_by__created_by__kebele_name=kebele_name)
    ...
    if response is not None:
        try:
            ...
            if get_user:
                ...
                my_group = Group.objects.get(name='farmer')
                ...
                if user and created_By:
                    ...
                    return Response("farmer creation failed")   
        except:
            return Response("something went wrong in the try block") 
    else:
